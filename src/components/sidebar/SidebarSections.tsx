...
export function ViewsSection({
  ...
  return (
    <div className="border-b border-border" style={{ padding: '0 6px' }}>
      <SidebarGroupHeader label={t('sidebar.views')} collapsed={collapsed} onToggle={onToggle}>
        {onCreateView && (
          <Plus
            size={12}
  ...
  return (
    <div className="border-b border-border">
      <div ref={customizeRef} style={{ position: 'relative', padding: '0 6px' }}>
        <SidebarGroupHeader label={t('sidebar.types')} collapsed={collapsed} onToggle={onToggle}>
          <div className="flex items-center gap-1.5">
            <Button
              type="button"
              variant="ghost"
              size="icon-xs"
              title={t('sidebar.customize_sections')}
              aria-label={t('sidebar.customize_sections')}
            ...
            {onCreateNewType && (
              <Button
                ...
                title={t('sidebar.create_new_type')}
                aria-label={t('sidebar.create_new_type')}
